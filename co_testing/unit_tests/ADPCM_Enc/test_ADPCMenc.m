...
fprintf(f2,'ADPCM_Encoder');
fclose(f2);

fprintf('#################################################################\n');
printtime();
fprintf('     Unit Testcase for ADPCM Encoder                  \n\n');
...
f2 = fopen('./test_vectors/adpcm_expected.txt','w');
for i=1:N
  fprintf(f2,'%d,%d\n',z000l(i),z000r(i));
end
fclose(f2);
